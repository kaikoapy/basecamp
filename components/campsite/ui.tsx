...
export function FileOggIcon(props: IconProps) {
  ...
  return (
    <svg width={size} height={size} fill="none" viewBox="0 0 24 24" {...rest}>
      ...
      <path
        d="M9.61559 17.6982C9.61559 18.8789 8.9857 19.585 7.93102 19.585C6.87633 19.585 6.24645 18.8789 6.24645 17.6982V17.0742C6.24645 15.8936 6.87633 15.1875 7.93102 15.1875C8.9857 15.1875 9.61559 15.8936 9.61559 17.0742V17.6982C9.61559 18.3252 9.43687 18.8174 9.11461 19.1426L9.55992 19.9482H8.58727ZM7.30699 17.7041C7.30699 18.4277 7.50328 18.7617 7.93102 18.7617L7.59117 18.1494H8.52281C8.54332 18.0205 8.55504 17.874 8.55504 17.7041V17.1357C8.55504 16.4121 8.35875 16.0781 7.93102 16.0781C7.50328 16.0781 7.30699 16.4121 7.30699 17.1357V17.7041ZM12.5361 19.5H11.4639V16.1367H10.3037V15.2725H13.6963V16.1367H12.5361V19.5ZM14.5954 19.5V18.8174L16.2946 16.1924V16.1367H14.6276V15.2725H17.5983V15.9551L15.8991 18.5801V18.6357H17.6598V19.5H14.5954Z"
        fill="white"
      />
    </svg>
  );
...
export function NewspaperOffIcon(props: IconProps) {
  const { size = 20, ...rest } = props;
