    ...
    >
      ...
      >
        ...
        >
          ...
          All your tools and resources—from Carfax to inventory—perfectly aligned in one hub for seamless access.
          </p>
        </Tabs.Trigger>
        <Tabs.Trigger
          className="group relative flex flex-1 flex-col items-start justify-start rounded-xl p-6 text-left shadow-lg ring-1 ring-gray-200 dark:ring-white/5 dark:data-[state=active]:shadow-indigo-900/30"
        ...
        >
          ...
          <p className="mt-4 leading-7 text-gray-600 dark:text-gray-400">
          Stop wasting time hunting across platforms; get every link and detail you need with a single click.
          </p>
        </Tabs.Trigger>
      </Tabs.List>
