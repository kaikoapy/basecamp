...
export const VolvoSalesHub: FunctionComponent = () => {
  ...
  const features = [
    {
      ...
      description:
        "Instantly access every external tool your Volvo sales team relies on—like Carfax, inventory sites, and dealership portals—streamlined into one hub for faster deal-making.",
    },
    {
      name: "Volvo Expertise",
      description:
        "Arm your team with in-depth Volvo product knowledge, from specs to features, so they can answer questions on the spot and close sales with unshakable confidence.",
    },
    {
      name: "Always Current",
      description:
        "Stay ahead with real-time updates to schedules, store directories, and resources—ensuring your team has the latest tools and info right when they need it.",
    },
  ];
  ...
  return (
    <div className="px-3">
      <section
        aria-labelledby="volvo-sales-hub-title"
      ...
      >
        ...
        <div className="z-10 inline-block rounded-lg border border-indigo-400/20 bg-indigo-800/20 px-3 py-1.5 font-semibold uppercase leading-4 tracking-tight sm:text-sm">
          <span className="bg-gradient-to-b from-indigo-200 to-indigo-400 bg-clip-text text-transparent">
            Built for Volvo Dealerships
          </span>
        </div>
        <h2
          id="volvo-sales-hub-title"
        ...
        >
          Your all-in-one <br /> sales headquarters
        </h2>
        <canvas
