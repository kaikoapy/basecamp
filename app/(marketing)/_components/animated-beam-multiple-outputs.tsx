...
const Icons = {
  carfax: () => (
    ...
    >
      <path
        d="M38.5 0H8.5C3.8 0 0 3.8 0 8.5v23C0 36.2 3.8 40 8.5 40h30c4.7 0 8.5-3.8 8.5-8.5v-23C47 3.8 43.2 0 38.5 0z"
        fill="#002D5C"
      />
      <path
        d="M14.2 30.5V9.5h7.6c2.2 0 4 0.7 5.2 2s1.9 3.1 1.9 5.3c0 2.2-0.6 4-1.9 5.3s-3 2-5.2 2h-4.4v6.4h-3.2zm3.2-9.1h4.4c1.3 0 2.3-0.4 3-1.2s1.1-1.9 1.1-3.3c0-1.4-0.4-2.5-1.1-3.3s-1.7-1.2-3-1.2h-4.4v9z"
        fill="#FFFFFF"
      />
      <path
        d="M31.8 30.5V9.5H35v21h-3.2z"
        fill="#FFFFFF"
      />
      <path
        d="M60 20.2c0-3.1 0.9-5.7 2.6-7.6s4-2.9 6.9-2.9c2.9 0 5.2 1 6.9 2.9s2.6 4.4 2.6 7.6c0 3.1-0.9 5.7-2.6 7.6s-4 2.9-6.9 2.9c-2.9 0-5.2-1-6.9-2.9S60 23.3 60 20.2zm3.4 0c0 2.2 0.6 4 1.7 5.2s2.6 1.9 4.4 1.9c1.8 0 3.3-0.6 4.4-1.9s1.7-3 1.7-5.2c0-2.2-0.6-4-1.7-5.2s-2.6-1.9-4.4-1.9c-1.8 0-3.3 0.6-4.4 1.9s-1.7 3-1.7 5.2z"
        fill="#002D5C"
      />
      <path
        d="M95.8 30.2h-3.2l-8.1-14.4v14.4h-3.2V9.8h3.2l8.1 14.4V9.8h3.2v20.4z"
        fill="#002D5C"
      />
      <path
        d="M112.5 30.2l-3.6-7.6h-7.3v7.6h-3.2V9.8h7.6c2.2 0 4 0.7 5.2 2s1.9 3.1 1.9 5.3c0 1.6-0.4 3-1.1 4s-1.8 1.8-3.1 2.2l4 7h-3.4zm-10.9-10.3h4.4c1.3 0 2.3-0.4 3-1.2s1.1-1.9 1.1-3.3c0-1.4-0.4-2.5-1.1-3.3s-1.7-1.2-3-1.2h-4.4v9z"
        fill="#002D5C"
      />
      <path
        d="M127.8 30.2h-11.5V9.8h11.5v2.7h-8.3v5.9h7.8v2.7h-7.8v6.4h8.3v2.7z"
        fill="#002D5C"
      />
      <path
        d="M144.5 30.2h-3.2l-8.1-14.4v14.4H130V9.8h3.2l8.1 14.4V9.8h3.2v20.4z"
        fill="#002D5C"
      />
    </svg>
  ),
