...
export default function Features() {
  return (
    <section
      ...
      className="mx-auto mt-8 sm:mt-12 w-full max-w-6xl px-3"
    >
            ...
            <div className="relative z-10 block h-full w-full overflow-hidden rounded-lg rounded-tr-[39px] bg-[#faf9f7] p-6 sm:p-8 md:p-12 shadow-[inset_0_0_0_1px] shadow-gray-200 transition-all duration-[180ms] ease-in-out hover:cursor-pointer hover:rounded-tr-[68px] before:absolute before:top-0 before:right-0 before:z-3 before:h-[45px] before:w-[45px] before:-translate-y-1/2 before:translate-x-1/2 before:rotate-45 before:bg-gray-50 before:shadow-[0_1px_0_0_] before:shadow-gray-200 before:transition-all before:duration-[180ms] before:ease-in-out before:content-[''] after:absolute after:top-0 after:right-0 after:z-2 after:size-[42px] after:-translate-y-2 after:translate-x-2 after:rounded-bl-lg after:border after:bg-gray-50 after:shadow-xs after:transition-all after:duration-[180ms] after:ease-in-out after:content-[''] hover:before:h-[75px] hover:before:w-[75px] hover:after:h-[63px] hover:after:w-[63px] hover:after:shadow-lg hover:after:shadow-black/5">
              ...
              <div className="relative space-y-4 sm:space-y-6">
                <div className="space-y-4 sm:space-y-6 font-mono">
                  <div className="text-xs sm:text-sm text-black">Founder Memo</div>
                  <h2 className="text-lg sm:text-xl font-mono tracking-tight text-black">
                    Everything. One place.
                  </h2>
                  <div className="h-px w-16 sm:w-24 bg-black/40" />
                </div>
                <div className="space-y-4 sm:space-y-6 text-muted-foreground text-sm sm:text-base md:text-lg/relaxed lg:text-sm/relaxed xl:text-lg/relaxed">
                ...
                {/* Signature */}
                <div className="mt-8 sm:mt-12 space-y-2 sm:space-y-3 font-mono text-black">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <Image
                      ...
                      width={32}
                      height={32}
                      className="size-6 sm:size-8 rounded-full object-cover ring-1 ring-black/10"
                    />
                    <div>
                      <p className="text-sm sm:text-base">Kai Koa</p>
